...
class PragyaStyle {
  static const boldnormal = TextStyle(fontSize: 20, fontWeight: FontWeight.bold);
  static const bold = TextStyle(fontSize: 20, color: Colors.black);
  static const white = TextStyle(color: Colors.white, fontWeight: FontWeight.bold);
  static const bold12 = TextStyle(fontSize: 20, color: Colors.black38);
